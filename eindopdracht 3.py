...
class HangmanGame(tk.Frame):
    ...
    def create_widgets(self):
        self.word_list = ["python", "programmeur", "scrum", "widget", "functie", "alex-jonkhart", "boolean", "greg", "tissaborsthaar", "julianbeffoto", "kakhart", "kanyingwest", "aanvallenjongens", "clashofclans"]
        self.new_game()
